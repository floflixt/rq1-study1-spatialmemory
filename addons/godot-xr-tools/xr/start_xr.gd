...
########## NOTE: THIS SCRIPT HAS BEEN CHANGED FROM THE PRESET (-> look for "FF:")
# changes have been made to switch from XRInterface to OpenXRInterface
# additionally, webxr features have been commented
...
###########
## FF: OpenXR signals + refresh rate
signal focus_lost
signal focus_gained
...
########## FF: switched from XRInterface to OpenXRInterface
