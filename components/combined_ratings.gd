...
func _ready() -> void:
	...
	$VBoxContainer/TabContainer.set_tab_title(0, "LIKE")
	$VBoxContainer/TabContainer.set_tab_title(1, "AI_GENERATED")
...
func _process(delta: float) -> void:
	...
	var total_ratings = like_rated + ai_rated
...
func _on_okay_button_pressed() -> void:
	...
	var ratings: String = str(like_rating) + "," + str(ai_rating)
