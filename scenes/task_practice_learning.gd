...
func _process(delta: float) -> void:
	...
	learning_tutorial_complete = $Images/PickableImageFrame1.rating_complete and $Images/PickableImageFrame2.rating_complete and $Images/PickableImageFrame3.rating_complete and $Images/PickableImageFrame4.rating_complete and $Images/PickableImageFrame5.rating_complete
